...
aws sqs purge-queue --queue-url http://localhost:4566/000000000000/giant-media-download-output-dead-letter-queue-DEV.fifo --endpoint-url http://localhost:4566
...
aws sqs purge-queue --queue-url http://localhost:4566/000000000000/giant-media-download-output-queue-DEV.fifo --endpoint-url http://localhost:4566
